    ...
    <div className='w-full p-5 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
      ...
      <form>
        <div>
          ...
          <input type="text" placeholder="Enter Fullname" className="input input-bordered w-full max-w-xs h-10" />
        </div>
        <div>
        <label className='label p-2' >
            <span className='text-base label-text'>Username</span>
            </label>
            <input type="username" placeholder="e.g:- @iamsrk " className="input input-bordered w-full max-w-xs h-10" />
        </div>
        <div>
        ...
        <label className='label p-0' >
            ...
            <input type="password" placeholder="Re-Enter password" className="input input-bordered w-full max-w-xs h-10" />
        </div>
        <div className="label">
        <GenderCheckbox />
            <span className="label-text-alt"></span>
            <a href='#' className="text-xs label-text link link-hover hover:text-gray-300 hover:underline hover:text-xs">Already have an account? Login.</a>
