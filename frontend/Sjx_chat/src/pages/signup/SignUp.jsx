    ...
    <div className='w-full p-5 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <input type="text" placeholder="Enter Fullname" className="input input-bordered w-full max-w-xs h-10 text-gray-900" 
        ...
        <label className='label p-2' >
            ...
            <input type="username" placeholder="e.g:- @iamsrk " className="input input-bordered w-full max-w-xs h-10 text-gray-900" 
        ...
        <label className='label p-0' >
            ...
            <input type="password" placeholder="Enter password" className="input input-bordered w-full max-w-xs h-10 text-gray-900" 
        ...
        <label className='label p-0' >
            ...
            <input type="password" placeholder="Re-Enter password" className="input input-bordered w-full max-w-xs h-10 text-gray-900" 
        ...
        <div>
        <button className='btn btn-sm btn-warning btn-block mt-2 border border-slate-700 max-w-xs'>Sign Up</button>
        </div>
