...
const SearchInput = () => {
  return (
    <form className='flex items-center gap-2'>
        <input type='text' placeholder='Search_' className='flex input input-boarded-sm bg-gray-800 bg-opacity-80 rounded-full mt-0 h-10' />
        <button type='submit' className='btn btn-circle glass h-5 max-w-15 btn-opacity-2 btn-outline' >
